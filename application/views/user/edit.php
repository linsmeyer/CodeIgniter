        ...
        <div class="widget-body no-padding">
            ...
            <form action="" method="post" class="smart-form" novalidate="novalidate">
                ...
                <fieldset>
                    ...
                    <legend>Editando Usuário: <?= $user->user_name ?></legend>

                    <div class="row">
                        <section class="col col-6">
                            <label class="label" for="user_name">Nome</label>
                            <label class="input">
                                <input type="text" name="user[user_name]" id="user_name" value="<?=$user->user_name?>">
                            </label>
                        </section>
                        <section class="col col-6">
                            <label class="label" for="user_email">Email:</label>
                            <label class="input">
                                <input type="text" name="user[user_email]" id="user_email" value="<?=$user->user_email?>"/>
                            </label>
                        </section>
                    </div>
                    ...
                    <div class="row">
                        <section class="col col-6">
                            ...
                            <label class="input">
                                <input type="text" name="user[user_phone]" id="user_phone" value="<?=$user->user_phone?>"/>
                            </label>
                        </section>
                        <section class="col col-6">
                            <label class="label" for="user_rg">RG:</label>
                            <label class="input">
                                <input type="text" name="user[user_rg]" id="user_rg" value="<?=$user->user_rg?>"/>
                            </label>
                        </section>
                    </div>
                    ...
                    <div class="row">
                        <section class="col col-6">
                            ...
                            <label class="input">
                                <input type="password" name="user[user_password]" id="user_password" maxlength="8" value="<?=$user->user_password?>"/>
                            </label>
                        </section>
                        <section class="col col-6">
                            <label class="label" for="user_cfm_password">Confirme a Senha:</label>
                            <label class="input">
                                <input type="password" name="user[user_cfm_password]" id="user_cfm_password" maxlength="8" value="<?=$user->user_cfm_password?>"/>
                            </label>
                        </section>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <section class="col col-6">
                            ...
                            <label class="input">
                                <input type="text" name="user[user_zip]" id="user_zip" maxlength="9" value="<?=$user->user_zip?>"/>
                            </label>
                        </section>
                    ...
                    <section>
                        <label for="address2" class="input">
                            ...
                            <label class="input">
                            <input type="text" name="user[user_address]" id="user_address" value="<?=$user->user_address?>"/>
                        </label>
                    </section>
                    ...
                    <section>
                        <div class="row">
                            <section class="col col-6">
                                ...
                                <label class="input">
                                    <input type="text" name="user[user_neighborhood]" id="user_neighborhood" value="<?=$user->user_neighborhood?>"/>
                                </label>
                            </section>
                            <section class="col col-6">
                                <label class="label" for="user_city">Cidade:</label>
                                <label class="input">
                                    <input type="text" name="user[user_city]" id="user_city" value="<?=$user->user_city?>"/>
                                </label>
                            </section>
                        </div>
                    </section>
                ...
                <footer>
                    <input type="submit" class="btn btn-primary" name="update_user" value="Atualizar"/>
                </footer>
            </form>
